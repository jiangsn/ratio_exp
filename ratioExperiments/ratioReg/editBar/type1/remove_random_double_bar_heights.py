...
def remove_random_double_bar_height(im, height_list, dots_positions, vertical_index=None):
    """随机删除两个竖着的 bar line
...
def change_numpy2removeRandomDoubleVerticalLine(
    ...
    for image_index, image in enumerate(image_numpy_data):
        new_image = remove_random_double_bar_height(im = image[0], 
    ...
    logger.info('将原始数据集修改为 Remove Random Double Bar Height.')
