...
@Description: 测试对 type1 随机删除两个 bar height
...
from ratioReg.editBar.type1.remove_random_double_bar_heights_keep_BarTop import change_numpy2removeRandomDoubleVerticalLineKeepBarTop
...
# 对原始数据集变化
zip_data = change_numpy2removeRandomDoubleVerticalLineKeepBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_double_bar_heights_keep_BarTop/')
