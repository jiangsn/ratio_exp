...
from ratioReg.editBar.type1.remove_bar_top import change_numpy2removeBarTop
...
# 对原始数据集变化
zip_data = change_numpy2removeBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_bar_top/')
