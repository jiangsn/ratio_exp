...
@Description: 测试对 type1 删除 bar-height
...
from ratioReg.editBar.type1.remove_bar_height import change_numpy2removeBarHeight
...
# 对原始数据集变化
zip_data = change_numpy2removeBarHeight(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_bar_height/')
