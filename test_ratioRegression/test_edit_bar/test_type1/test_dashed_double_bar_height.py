...
from ratioReg.editBar.type1.dashed_double_bar_height import change_numpy2dashedRandomDoubleVerticalLineKeepBarTop
...
# 对原始数据集变化
zip_data = change_numpy2dashedRandomDoubleVerticalLineKeepBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/dashed_double_bar_heights_keep_BarTop/')
