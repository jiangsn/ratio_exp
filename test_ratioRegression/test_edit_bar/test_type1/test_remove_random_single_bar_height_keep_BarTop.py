...
@Description: 测试对 type1 随机删除一个 bar height
...
from ratioReg.editBar.type1.remove_random_single_bar_height_keep_barTop import change_numpy2removeRandomSingleBarHeightKeepBarTop
...
# 对原始数据集变化
zip_data = change_numpy2removeRandomSingleBarHeightKeepBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_single_bar_height_keep_BarTop/')
