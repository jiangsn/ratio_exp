...
from ratioReg.editBar.type1.remove_random_single_bar_height import change_numpy2removeRandomSingleBarHeight
...
# 对原始数据集变化
zip_data = change_numpy2removeRandomSingleBarHeight(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_single_bar_height/')
