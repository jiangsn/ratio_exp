...
@Description: 测试对 type1 移动 bar-top
...
from ratioReg.editBar.type1.move_bar_top import change_numpy2moveBarTop
...
# 对原始数据集变化
zip_data = change_numpy2moveBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/move_bar_top/')
...
for image_index in image_indexs:
    ...
    new_ratio = label_numpy_data[image_index][0] # 获得此时新的 ratio

    # 保存图像
    save_ratio_image(convert_image, os.path.join(save_path, '{}_convert_image_{:.4f}.jpg'.format(image_index, new_ratio)))
