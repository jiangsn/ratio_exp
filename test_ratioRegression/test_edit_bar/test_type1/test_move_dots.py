...
from ratioReg.editBar.type1.move_dots import change_numpy2movedots
...
# 对原始数据集变化
zip_data = change_numpy2movedots(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/move_dots/')
...
for image_index in image_indexs:
    ...
    # 保存图像
    save_ratio_image(convert_image, os.path.join(save_path, '{}_convert_image_{:.2f}.jpg'.format(image_index, new_ratio)))
