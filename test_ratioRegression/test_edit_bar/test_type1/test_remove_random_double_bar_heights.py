...
from ratioReg.editBar.type1.remove_random_double_bar_heights import change_numpy2removeRandomDoubleVerticalLine
...
# 对原始数据集变化
zip_data = change_numpy2removeRandomDoubleVerticalLine(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_double_bar_heights/')
