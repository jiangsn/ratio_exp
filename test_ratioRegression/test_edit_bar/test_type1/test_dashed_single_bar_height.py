...
@Description: 测试对 type1 随机虚线一个 bar height
...
from ratioReg.editBar.type1.dashed_single_bar_height import change_numpy2dashedRandomSingleBarHeightKeepBarTop
...
# 对原始数据集变化
zip_data = change_numpy2dashedRandomSingleBarHeightKeepBarTop(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/dashed_single_bar_height_keep_BarTop/')
