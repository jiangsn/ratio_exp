...
from ratioReg.editBar.type1.remove_dots import change_numpy2removedots
...
# 对原始数据集变化
zip_data = change_numpy2removedots(
...
# 存储路径
save_path = pathConvert('../../../exp_output/editbar/remove_dots/')
